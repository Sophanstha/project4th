        ...
        <div class="lowernav">
            ...
            <div class="icon">
               ...
               <button class="search-close"><i class="fa-solid fa-x"></i></button>
                <!-- <i class="fa-solid fa-user" id="log"></i> -->
                <?php
if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']) {
    ...
    <div id="chelp">
        <div class="hdiv">
            <h1>Press</h1>
            <p>Are you interested in our latest news or want to partner with us and need to get in touch?
            </p>
            <a href="blog.html">Visit page</a>
        </div>
        <div class="hdiv">
            <h1>Help ?</h1>
            <p>Our support team is spread across the Nepal to give you answers fast.</p>
            <a href="contact.html">Visit support pages</a>
        </div>
        <div class="hdiv">
            <h1 style="margin-top:-45px ;">Sales</h1>
           <p>team to see how we can work together.</p>
    ...
    <div class="divfrom">
       <div class="from">
        <form action="" method="post">
            ...
            <br>
            <input type="number" name="cnumber" id="cmumber" placeholder="Enter your number" required>
            <input type="text" name="csubject" id="csubject" placeholder="your subject">
            <br>
            <textarea name="textarea" id="textarea" cols="30" rows="10" placeholder="your message"></textarea>
    

        </form>
        <button class="Btn" type="submit" name="sublit" >
        Submit
          </button>
       </div> 
    </div>
